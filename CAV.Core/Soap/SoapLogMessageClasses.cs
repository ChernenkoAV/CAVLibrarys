...
namespace Cav.Soap
{
    ...
    /// </summary>
    internal class SoapServiceErrorHandler : IErrorHandler, IServiceBehavior
    {
        public SoapServiceErrorHandler(Action<Exception> handler)
        {
        ...
        public bool HandleError(Exception error)
        {
            ...
            (new Task(SoapServiceErrorHandler.runhandler, Tuple.Create(handler, error))).Start();
